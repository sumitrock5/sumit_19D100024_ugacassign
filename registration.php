...
<body><br>
	...
	<div class="container">
	    ...
	    <label for="passconfirm"><strong>Confirm Password:</strong></label><br>
	    <input type="password" id="passconfirm" name="passwordc" required><br><br>
		<input type="submit" name="create" value="Sign Up" class="btn btn-secondary">
		<a class="btn btn-secondary" href="login.php" role="button">Log In</a>
	</form>
	</div>
</body>
</html>